        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <!-- Download Template -->
                    <div class="mb-4">
                        <a href="{{ route('contacts.template') }}" class="btn btn-outline-primary">
                    ...
                    <form action="{{ route('contacts.import', $contactList) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="tag_id" id="tag_id" class="form-select @error('tag_id') is-invalid @enderror">
                            ...
                            @enderror
                            <small class="text-muted">
                                All imported contacts will be tagged automatically
                            </small>
                        </div>
