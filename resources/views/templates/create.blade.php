...
<div class="container-fluid py-4">
    ...
    <div class="d-flex align-items-center mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">Design your message template with dynamic variables</p>
        </div>
    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                   placeholder="e.g., Welcome Message" value="{{ old('name') }}" required>
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                                      rows="2" placeholder="Brief description of this template...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" id="templateContent" class="form-control @error('content') is-invalid @enderror" 
                                      rows="8" placeholder="Type your message here... Use {variable_name} for dynamic content" required>{{ old('content') }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-0" id="mediaUrlGroup" style="display: none;">
                                    ...
                                    <input type="url" name="media_url" class="form-control" 
                                           placeholder="https://example.com/image.jpg" value="{{ old('media_url') }}">
